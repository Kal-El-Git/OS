...
typedef struct _mapreduce_t
{
	...
	void (*map)(int, const char*);//map function
	const char *(*reduce)(const char*, const char*);//reduce function

	datastore_t d;// the data store structure 

	const char** data;// the data passed in to the function
